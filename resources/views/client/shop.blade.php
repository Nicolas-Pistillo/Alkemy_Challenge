            ...
            @else
                ...
                <div class="h-full w-full flex items-center">
                    <div class="container flex flex-col mx-auto md:flex-row items-center justify-center px-5 text-gray-700">
                        <div class="max-w-md">
                            <h2 class="text-5xl font-dark font-bold mb-2">Upps...</h2>
                            <p
                            class="text-2xl md:text-3xl font-light leading-normal"
                            >No hay aplicaciónes por aquí</p>
                            <p class="mb-8">Se dice que el que sabe lo que busca encuentra lo que quiere, camarada. ¡Muy pronto habra muchas aplicaciones de esta categoria!</p>
                        </div>
                        <div class="max-w-lg">
